 ...
 * Slug: pasigraphy/product-box-dark
...
<div class="wp-block-group stacked has-base-color has-contrast-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--small);padding-right:var(--wp--preset--spacing--small);padding-bottom:var(--wp--preset--spacing--small);padding-left:var(--wp--preset--spacing--small)">
	...
	<div class="wp-block-columns are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:35%">
			...
			<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/sample_white_800x800.jpg'; ?>" alt="<?php echo esc_attr__( 'pasigraphy Theme Sample Image', 'pasigraphy' ); ?>"/></figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column is-vertically-aligned-center">
			...
			<h2 class="wp-block-heading has-large-font-size"><?php echo esc_html__( 'pasigraphy WordPress Theme', 'pasigraphy' ); ?></h2>
			<!-- /wp:heading -->
			<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.5"}}} -->
			<p style="line-height:1.5"><?php echo esc_html__( 'The ultimate WordPress block theme for agencies and website builders.', 'pasigraphy' ); ?></p>
			<!-- /wp:paragraph -->
			<!-- wp:buttons -->
