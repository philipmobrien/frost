 ...
 * Slug: pasigraphy/footer-stacked
 * Categories: footer
...
<div class="wp-block-group alignfull" style="margin-top:0px;padding-top:var(--wp--preset--spacing--x-large);padding-right:30px;padding-bottom:var(--wp--preset--spacing--small);padding-left:30px">
	...
	<p class="has-text-align-center has-small-font-size">&copy; 2023 <?php echo esc_html__( 'Your Company LLC', 'pasigraphy' ); ?> · <a href="#"><?php echo esc_html__( 'Contact Us', 'pasigraphy' ); ?></a></p>
	<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
