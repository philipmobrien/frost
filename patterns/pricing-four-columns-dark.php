 ...
 * Slug: pasigraphy/pricing-four-columns-dark
...
<div class="wp-block-group alignwide">
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column has-base-color has-contrast-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--small);padding-right:var(--wp--preset--spacing--small);padding-bottom:var(--wp--preset--spacing--small);padding-left:var(--wp--preset--spacing--small)">
			...
			<div class="wp-block-group">
				<!-- wp:paragraph {"align":"center","style":{"typography":{"lineHeight":"1.5"}},"fontSize":"small"} -->
				<p class="has-text-align-center has-small-font-size" style="line-height:1.5"><?php echo esc_html__( 'Ultime', 'pasigraphy' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"align":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"500"}},"fontSize":"max-36"} -->
				<p class="has-text-align-center has-max-36-font-size" style="font-style:normal;font-weight:500"><?php echo esc_html__( '$995/yr.', 'pasigraphy' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			<!-- wp:group {"style":{"spacing":{"blockGap":"10px"}},"layout":{"type":"constrained"}} -->
