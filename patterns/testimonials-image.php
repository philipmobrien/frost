 ...
 * Slug: pasigraphy/testimonials-image
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column has-border-color has-contrast-border-color" style="border-width:1px;padding-top:var(--wp--preset--spacing--small);padding-right:var(--wp--preset--spacing--small);padding-bottom:var(--wp--preset--spacing--small);padding-left:var(--wp--preset--spacing--small)">
			...
			<div class="wp-block-group">
				...
				<figure class="wp-block-image size-full is-resized has-custom-border is-style-rounded"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/sample_800x800.jpg'; ?>" alt="<?php echo esc_attr__( 'Testimonial Avatar', 'pasigraphy' ); ?>" style="border-radius:50px" width="60" height="60"/></figure>
				<!-- /wp:image -->
