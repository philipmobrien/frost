 ...
 * Slug: pasigraphy/boxes-two-dark
 * Categories: featured
 */
?>
...
<div class="wp-block-group alignwide">
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column has-base-color has-contrast-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--medium)">
			...
			<h3 class="wp-block-heading has-x-large-font-size" id="sample-heading-1"><?php echo esc_html__( 'Build with pasigraphy', 'pasigraphy' ); ?></h3>
			<!-- /wp:heading -->
			<!-- wp:paragraph -->
			...
			<div class="wp-block-buttons">
				<!-- wp:button -->
				<div class="wp-block-button"><a class="wp-block-button__link wp-element-button"><?php echo esc_html__( 'Learn More', 'pasigraphy' ); ?></a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
		</div>
